...
export const ARCHIVES = [
  { name: "MARTIN MARGIELA", years: "1999–2008", live: false },
  {
    ...
    editorialSlug: null,
    description:
      "Hedi Slimane reshaped modern menswear at Dior Homme (2000–2007), defining a radically slim, youthful silhouette that became one of the most influential aesthetics of the 2000s. He later revisited and brought his signature visuals to Saint Laurent during the early 2010s, merging sharp tailoring with rock and youth culture. It is a testament to Slimane's influence that the silhouettes he propelled into the mainstream have found renewed relevance nearly two decades later with the \"Hedi Boy\" movement.",
    rules: [
