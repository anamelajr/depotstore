...
export default function Nav({ onAboutOpen, stores = [] }) {
  ...
  return (
    <>
      {/* Mobile nav */}
      <nav className={`sticky top-0 z-50 flex h-[50px] items-center ${hasMobileSearchBanner ? "" : "border-b border-zinc-200"} bg-white/95 text-zinc-950 backdrop-blur md:hidden`}>
            ...
            {isMobileSearchOpen ? (
              <div className="flex items-center w-full h-[50px] px-5 gap-3">
                <input
                  ...
                  className="font-mono tracking-widest uppercase bg-transparent text-zinc-950 placeholder-zinc-400 outline-none flex-1 origin-left"
              ...
              <>
                <Link href="/" className="font-mono text-[13px] tracking-[0.15em] text-zinc-950">
                  DÉPÔT
                </Link>
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex flex-col gap-[5px] p-1 text-zinc-600 hover:text-zinc-950 transition-colors"
